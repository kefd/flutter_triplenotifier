...
class CounterTripleNotifierPage extends StatefulWidget {
  final String title;
  const CounterTripleNotifierPage({Key? key, required this.title})
      : super(key: key);

  @override
  State<CounterTripleNotifierPage> createState() =>
      _CounterTripleNotifierPageState();
}

class _CounterTripleNotifierPageState extends State<CounterTripleNotifierPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: counterMenu(2));
  }
}
